...
const allParams: AllParameters = {
    virtualSchemaName: { id: "virtualSchemaName", name: "Virtual schema name", type: "string", required: true, regex: "[a-zA-Z][a-zA-Z0-9_]*", description: "Name for the new virtual schema", placeholder: "MY_VIRTUAL_SCHEMA" },
