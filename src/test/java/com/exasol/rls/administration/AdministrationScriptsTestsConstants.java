...
public final class AdministrationScriptsTestsConstants {
    // Lua scripts
    private static final Path ADMIN_SCRIPT_BASE_PATH = Path.of("src/main/lua/administration/");
    ...
    private AdministrationScriptsTestsConstants() {
