...
--
-- @param exasol_context handle to the Exasol context of the Lua script this reader runs in
--
-- @return metadata reader
--
function MetadataReader.create(exasol_context)
    return MetadataReader:new({exasol_context = exasol_context})
end
...
function MetadataReader.new(exasol_context)
    local self = {exasol_context = exasol_context}
    ...
    --
    function self.read(schema_id, include_tables)
