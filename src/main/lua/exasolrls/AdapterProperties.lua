...
function AdapterProperties.new (raw_properties)
    local self = {raw_properties = raw_properties}
    ...
    --
    function self.get(property_name)
    ...
    --
    function self.is_property_set(property_name)
    ...
    --
    function self.has_value(property_name)
    ...
    --
    function self.is_empty(property_name)
    ...
    --
    function self.get_table_filter()
